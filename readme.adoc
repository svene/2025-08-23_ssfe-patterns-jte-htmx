...
.page1.jte
----
<!-- HYPERMEDIA-PATTERN: Template-Injection -->
...
<head>
    <meta charset="UTF-8">
    <title>Hypermedia-Patterns Demo with Plain JTE</title>
...
<!-- HYPERMEDIA-PATTERN: Template-Inclusion: -->
...
<head>
    <meta charset="UTF-8">
	<title>Hypermedia-Patterns Demo with JTE-VC</title>
	<script src="/webjars/htmx.org/2.0.4/dist/htmx.js"></script>
</head>
----
